                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${tx.type === 'SALE' ? 'bg-emerald-500/10 text-emerald-500' : 'bg-rose-500/10 text-rose-500'}`}>
                                    {tx.type === 'SALE' ? <FiArrowUpRight size={20} /> : <FiArrowDownLeft size={20} />}
                                </div>
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        <span className="text-[11px] text-slate-500 flex items-center gap-1 font-medium">
                                            <FiCalendar size={12} /> {new Date(tx.createdAt).toLocaleDateString()}
                                        </span>
                                        <span className="text-[11px] text-slate-500 flex items-center gap-1 font-medium">
                                            <FiClock size={12} /> {new Date(tx.createdAt).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}
                                        </span>
                                    </div>
                                </div>
                            </div>
